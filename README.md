...
- Install on local via SSH
  - supercomputer sometimes prevent parallel process in login node, at that time, use `TOKIO_WORKER_THREADS=1 RAYON_NUM_THREADS=1 ./install.sh --python3 --pixi-pkgs` for instead
